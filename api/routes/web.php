...
Route::get('/changeTotalPriceRequired', [GarbageController::class, 'changeTotalPriceRequired']);
...
// Route::get('/changeRoomRequired', [GarbageController::class, 'changeRoomRequired']);
