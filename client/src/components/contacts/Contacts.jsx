      ...
      <div className="contain">
        <div className="contacts__main">
          <div className="contacts__main-right">
            ...
            <div className="contacts__main-right-info">
              {adminTel && (
                <a href={`tel:${adminTel}`}>
                  {tel.icon} {adminTel}
                </a>
            ...
            <div className="contacts__main-right-social">
              <a
                href="https://www.facebook.com/apartorealestate/"
                target="/blank"
              >
                {fb.icon}
              </a>
              <a href="https://www.tiktok.com/@aparto.am" target="/blank">
                {tiktok.icon}
              </a>
              <a href="https://www.instagram.com/aparto.am/" target="/blank">
                {insta.icon}
              </a>
            </div>
          </div>
          ...
          <div className="contacts__main-left">
            <iframe
              title="contactsMap"
              className="contacts__main-left-map"
